...
function get_ip_xor_mask_from_user {
        ...
        read -p "In order to hide the original IPs in the output file generated by this script, we added the option of Xoring the IPs. Please enter a fake IP here,  Otherwise please press enter. " user_ip_xor_mask
